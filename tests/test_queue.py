...
class TestQueueManager:
    ...
    @patch('src.queue.queue_manager.pika.BlockingConnection')
    def test_publish_cep(self, mock_connection_class):
    ...
    @patch('src.queue.queue_manager.pika.BlockingConnection')
    def test_publish_multiple_ceps(self, mock_connection_class):
    ...
    @patch('src.queue.queue_manager.pika.BlockingConnection')
    def test_get_queue_size(self, mock_connection_class):
    ...
    @patch('src.queue.queue_manager.pika.BlockingConnection')
    def test_purge_queue(self, mock_connection_class):
        """Test purging queue"""
        mock_connection = Mock()
        mock_channel = Mock()
        mock_channel.is_closed = False
